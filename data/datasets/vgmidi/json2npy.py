...
for idx, item in enumerate(tqdm(data, desc="Processing captions"), start=1):
    ...
    try:
        # データの準備
        all_words = cp.prepare_data(midi_paths=[midi], task="", max_len=512)
...
np.save("/home/Nakata/Music-Tri-Modal/data/datasets/vgmidi/vgmidi.npy", all_data)
np.save("/home/Nakata/Music-Tri-Modal/data/datasets/vgmidi/vgmidi_ans.npy", all_ans)
...
# 分割データを保存
np.save("/home/Nakata/Music-Tri-Modal/data/datasets/vgmidi/vgmidi_train.npy", train_data)
np.save("/home/Nakata/Music-Tri-Modal/data/datasets/vgmidi/vgmidi_train_ans.npy", train_labels)
np.save("/home/Nakata/Music-Tri-Modal/data/datasets/vgmidi/vgmidi_val.npy", val_data)
np.save("/home/Nakata/Music-Tri-Modal/data/datasets/vgmidi/vgmidi_val_ans.npy", val_labels)
np.save("/home/Nakata/Music-Tri-Modal/data/datasets/vgmidi/vgmidi_test.npy", test_data)
np.save("/home/Nakata/Music-Tri-Modal/data/datasets/vgmidi/vgmidi_test_ans.npy", test_labels)
